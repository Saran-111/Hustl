  ...
  public MessageDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfMessage = new EntityInsertionAdapter<Message>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `messages` (`messageId`,`chatId`,`senderId`,`senderName`,`text`,`timestamp`,`isRead`) VALUES (?,?,?,?,?,?,?)";
      }
      ...
      public List<Message> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _tmpIsRead = _tmp != 0;
            _item = new Message(_tmpMessageId,_tmpChatId,_tmpSenderId,_tmpSenderName,_tmpText,_tmpTimestamp,_tmpIsRead);
            _result.add(_item);
          }
          return _result;
        } finally {
